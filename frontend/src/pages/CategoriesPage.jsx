...
const CAT_CONFIG = {
  'perfumes': {
    ...
    subCategories: [
      { name: 'Arabian Oud', img: '/images/arabian-oud.webp' },
      { name: 'Designer', img: '/images/designer-perfumes.webp' },
    ],
  },
  'makeup': {
    gradient: 'from-pink-500 via-rose-500 to-red-500',
    lightGradient: 'from-pink-50 to-rose-50',
    img: '/images/makeup-category.webp',
    ...
    subCategories: [
      { name: 'Face', img: '/images/makeup-collection.webp' },
      { name: 'Lips', img: '/images/lip-collection.webp' },
    ],
  },
  'hair-care': {
    ...
    subCategories: [
      { name: 'Treatment', img: '/images/repair-restore.webp' },
      { name: 'Styling', img: '/images/styling-essentials.webp' },
    ],
  },
  'body-care': {
    gradient: 'from-emerald-500 via-teal-500 to-cyan-500',
    lightGradient: 'from-emerald-50 to-teal-50',
    img: '/images/body-care-category.webp',
    ...
    subCategories: [
      { name: 'Spa', img: '/images/spa-at-home.webp' },
      { name: 'Summer', img: '/images/summer-ready.webp' },
    ],
  },
  'personal-care': {
    gradient: 'from-blue-500 via-indigo-500 to-purple-500',
    lightGradient: 'from-blue-50 to-indigo-50',
    img: '/images/personal-care-category.webp',
    ...
    subCategories: [
      { name: 'Daily', img: '/images/daily-essentials.webp' },
      { name: 'Skincare', img: '/images/skincare-picks.webp' },
    ],
  },
}
