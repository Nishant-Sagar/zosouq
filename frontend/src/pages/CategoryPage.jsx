...
const CATEGORY_THEMES = {
  perfumes: {
    ...
    accent: 'violet',
    accentColor: '#7c3aed',
    poster: 'https://images.unsplash.com/photo-1541643600914-78b084683702?w=1400&fit=crop',
    ...
    promos: [
      { title: 'Arabian Oud Collection', sub: 'Exclusive fragrances from the finest oud', img: 'https://images.unsplash.com/photo-1583083527882-4bee9aba2eea?w=800&fit=crop', gradient: 'from-violet-700 to-purple-900' },
      { title: 'Designer Perfumes', sub: 'Up to 60% less than retail', img: 'https://images.unsplash.com/photo-1595535873420-a599195b3f4a?w=800&fit=crop', gradient: 'from-fuchsia-600 to-pink-800' },
    ],
  ...
  makeup: {
    ...
    accent: 'pink',
    accentColor: '#ec4899',
    poster: 'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=1400&fit=crop',
    tagline: 'Glow Like Never Before',
    description: 'Premium foundations, lipsticks, eyeshadows & more from top international brands.',
    promos: [
      { title: 'Foundation Edit', sub: 'Find your perfect shade match', img: 'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=800&fit=crop', gradient: 'from-rose-600 to-pink-800' },
      { title: 'Lip Collection', sub: 'Trending shades this season', img: 'https://images.unsplash.com/photo-1586495777744-4e6232bf8dea?w=800&fit=crop', gradient: 'from-red-500 to-rose-700' },
    ],
  ...
  'hair-care': {
    ...
    accent: 'amber',
    accentColor: '#f59e0b',
    poster: 'https://images.unsplash.com/photo-1527799820374-dcf8d9d4a388?w=1400&fit=crop',
    tagline: 'Healthy Hair, Happy You',
    description: 'Professional shampoos, conditioners, masks & styling products for every hair type.',
    promos: [
      { title: 'Repair & Restore', sub: 'Deep conditioning treatments', img: 'https://images.unsplash.com/photo-1527799820374-dcf8d9d4a388?w=800&fit=crop', gradient: 'from-amber-600 to-orange-800' },
      { title: 'Styling Essentials', sub: 'Professional results at home', img: 'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=800&fit=crop', gradient: 'from-yellow-500 to-amber-700' },
    ],
  ...
  'body-care': {
    ...
    accent: 'emerald',
    accentColor: '#10b981',
    poster: 'https://images.unsplash.com/photo-1609008803827-6d91a41e3a2e?w=1400&fit=crop',
    tagline: 'Pamper Your Body',
    description: 'Luxury body scrubs, lotions, washes & spa essentials for radiant, silky-smooth skin.',
    promos: [
      { title: 'Spa at Home', sub: 'Luxury body scrubs & masks', img: 'https://images.unsplash.com/photo-1540555700478-4be289fbecef?w=800&fit=crop', gradient: 'from-teal-600 to-emerald-800' },
      { title: 'Summer Ready', sub: 'Moisturize & glow all day', img: 'https://images.unsplash.com/photo-1572635196237-14b3f281503f?w=800&fit=crop', gradient: 'from-cyan-500 to-teal-700' },
    ],
  ...
  'personal-care': {
    ...
    accent: 'blue',
    accentColor: '#3b82f6',
    poster: 'https://images.unsplash.com/photo-1556228578-8c89e6adf883?w=1400&fit=crop',
    tagline: 'Self Care is the Best Care',
    description: 'Cleansers, moisturizers, serums, sunscreens & everyday essentials you can trust.',
    promos: [
      { title: 'Daily Essentials', sub: 'Everything for your routine', img: 'https://images.unsplash.com/photo-1556228720-195a672e8a03?w=800&fit=crop', gradient: 'from-blue-600 to-indigo-800' },
      { title: 'Skincare Picks', sub: 'Serums, cleansers & more', img: 'https://images.unsplash.com/photo-1556228453-efd6c1ff04f6?w=800&fit=crop', gradient: 'from-indigo-500 to-purple-700' },
    ],
...
const DEFAULT_THEME = {
  ...
  accent: 'gray',
  accentColor: '#6b7280',
  poster: 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=800&fit=crop',
