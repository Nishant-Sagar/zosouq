...
const CATEGORY_THEMES = {
  perfumes: {
    ...
    accent: 'violet',
    accentColor: '#7c3aed',
    poster: '/images/poster-perfumes.jpg',
    ...
    promos: [
      { title: 'Arabian Oud Collection', sub: 'Exclusive fragrances from the finest oud', img: '/images/arabian-oud.jpg', gradient: 'from-violet-700 to-purple-900' },
      { title: 'Designer Perfumes', sub: 'Up to 60% less than retail', img: '/images/designer-perfumes.jpg', gradient: 'from-fuchsia-600 to-pink-800' },
    ],
  ...
  makeup: {
    ...
    accent: 'pink',
    accentColor: '#ec4899',
    poster: '/images/poster-makeup.jpg',
    tagline: 'Glow Like Never Before',
    description: 'Premium foundations, lipsticks, eyeshadows & more from top international brands.',
    promos: [
      { title: 'Foundation Edit', sub: 'Find your perfect shade match', img: '/images/makeup-collection.jpg', gradient: 'from-rose-600 to-pink-800' },
      { title: 'Lip Collection', sub: 'Trending shades this season', img: '/images/lip-collection.jpg', gradient: 'from-red-500 to-rose-700' },
    ],
  ...
  'hair-care': {
    ...
    accent: 'amber',
    accentColor: '#f59e0b',
    poster: '/images/poster-haircare.jpg',
    tagline: 'Healthy Hair, Happy You',
    description: 'Professional shampoos, conditioners, masks & styling products for every hair type.',
    promos: [
      { title: 'Repair & Restore', sub: 'Deep conditioning treatments', img: '/images/repair-restore.jpg', gradient: 'from-amber-600 to-orange-800' },
      { title: 'Styling Essentials', sub: 'Professional results at home', img: '/images/styling-essentials.jpg', gradient: 'from-yellow-500 to-amber-700' },
    ],
  ...
  'body-care': {
    ...
    accent: 'emerald',
    accentColor: '#10b981',
    poster: '/images/poster-bodycare.jpg',
    tagline: 'Pamper Your Body',
    description: 'Luxury body scrubs, lotions, washes & spa essentials for radiant, silky-smooth skin.',
    promos: [
      { title: 'Spa at Home', sub: 'Luxury body scrubs & masks', img: '/images/spa-at-home.jpg', gradient: 'from-teal-600 to-emerald-800' },
      { title: 'Summer Ready', sub: 'Moisturize & glow all day', img: '/images/summer-ready.jpg', gradient: 'from-cyan-500 to-teal-700' },
    ],
  ...
  'personal-care': {
    ...
    accent: 'blue',
    accentColor: '#3b82f6',
    poster: '/images/poster-personalcare.jpg',
    tagline: 'Self Care is the Best Care',
    description: 'Cleansers, moisturizers, serums, sunscreens & everyday essentials you can trust.',
    promos: [
      { title: 'Daily Essentials', sub: 'Everything for your routine', img: '/images/daily-essentials.jpg', gradient: 'from-blue-600 to-indigo-800' },
      { title: 'Skincare Picks', sub: 'Serums, cleansers & more', img: '/images/skincare-picks.jpg', gradient: 'from-indigo-500 to-purple-700' },
    ],
...
const DEFAULT_THEME = {
  ...
  accent: 'gray',
  accentColor: '#6b7280',
  poster: '/images/makeup-tools.jpg',
